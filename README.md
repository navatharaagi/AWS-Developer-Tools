...
- After successful Source,Build,Beta stages - Approval Stage waits for our approval->Goto Email which subscribed for SNS notifications->Click on Approval Email->Click on URL to Approve  Click on Review->  
