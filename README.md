...
- Goto AWS Console-->CodePipeline-->JenkinsPipeline-->Edit-->Add Action at "Build" Stage by clicking on "Action"-->Action Category select "Build"-->Action Name "CustomBuild"--> 
