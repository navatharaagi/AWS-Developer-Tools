...
- AWS Console->EC2->Amazon Linux AMI->select Free Tier micro-> Configure Instance Details->IAM Role->select “JenkinsEC2Role”-> Advanced Details->copy & paste above bash script
